...
- Mobile: Android, Kotlin, Java, Jetpack Compose, Kotlin Multiplatform, Coroutines/Flow, Retrofit/OkHttp, Dagger/Hilt; React Native, Expo; iOS (Swift, SwiftUI); Flutter (Dart)
...
- Increment Loop (Belgrade, Serbia), from 2023 — Android/Kotlin (Yuno app).
...
- *Fundamental Kotlin* — self-published author, 3rd revised edition (2022). Also authored for Packt Publishing UK.

## Education

- M.Sc., Contemporary Information Technologies — University Singidunum, Belgrade (2014)
- B.Sc., Informatics and Computing — University Singidunum, Belgrade (2008)
